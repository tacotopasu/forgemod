package net.ramencafe.forwardrooms;
...
@Mod(ForwardRooms.MOD_ID)
public class ForwardRooms
{
    public static final String MOD_ID = "forwardrooms";
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo(MOD_ID, "helloworld", () -> { LOGGER.info("Hello world from the CCPhttps://www.amazon.com/gp/bestsellers/hi/511394"); return "Hello world";});
    }
